...
from .models import Category, Brand, Product, BrandProduct, Section, SectionItems
from .forms import (AddBrandForm, UpdateBrandForm, AddCategoryForm,
                    AddProductForm, UpdateProductForm, UpdateSectionForm,
                    AddSectionForm, AddSectionModelForm)
