    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_items', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.orderitems')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='order_items',
            field=models.ManyToManyField(through='products.OrderManager', to='products.orderitems'),
        ),
    ]
